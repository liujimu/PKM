...
I_p=0.8*[57.052445 1.5458544 0.89249891;1.5458544 28.987507 -3.9659254;0.89249891 -3.9659254  33.566962];%动平台惯量矩阵
plat_cm=[-1.5884037e-01 3.9104250e-02 2.2576860e-02]'; %动平台质心坐标

I_l=[3.5 0 0;0 3.5 0;0 0 18.97E-003];%连杆惯量矩阵
m_p=250.02933;%动平台质量
m_l=27*[1 1 1 1 1 1];%连杆质量 3.4455182e+06*7.9*10^3/10^9
m_s=69.4;%滑块质量 8.7874943e+06*7.9*10^3/10^9
%Is=8E-004*1.1;%丝杠转动惯量


%机构结构尺寸定义，单位取为m
sH=0.58;%对接面至动平台铰点中心的高度
    ...
    M_equ=M_lequ+M_pequ;
    %刚度矩阵
    Ks_sc=0.0035*210/lr*10^9;%连杆拉压刚度
    %Ks_sc=0.43*10^9;
